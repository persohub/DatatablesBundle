...
(function ($) {
    ...
    $.fn.rowReordering = function (options) {
        ...
        function fnGetStateOriginal(oTable, sSelector, id) {
        ...
        function fnGetState(oTable, sSelector, id) {
            ...
            var sDirection;
            var trPrevious = tr.prev(sSelector);
            iNewPosition = oTable.fnGetData(trPrevious[0], properties.iIndexColumn);
//            if (trPrevious.length > 0) {
//                if (iNewPosition < iCurrentPosition) {
//                    iNewPosition = iNewPosition + 1;
//                }
...
//                        console.log("dsfds");
//                        console.log($(ui.item));
//                        console.log(properties.sDataGroupAttribute);
